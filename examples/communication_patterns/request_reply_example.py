...
class ReqRep(MiddlewareCommunicator):
    ...
    def send_message(self, msg=None, img_width=320, img_height=240, mware=None, *args, **kwargs):
...
def main(args):
    ...
    while True:
        ...
        if args.mode == "request":
            ...
            my_message, my_image = req_rep.send_message(msg, counter=counter, mware=args.mware)
            counter += 1
        ...
        if args.mode == "reply":
            ...
            my_message, my_image = req_rep.send_message(mware=args.mware)
            if my_message is not None:
