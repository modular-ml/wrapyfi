...
from wrapyfi.middlewares.zeromq import ZeroMQMiddlewareRepReq, ZeroMQMiddlewarePubSub
...
def parse_args():
    ...
    parser.add_argument("--comm_type", type=str, default="pubsub", choices=["pubsub", "pubsubpoll", "repreq"],
